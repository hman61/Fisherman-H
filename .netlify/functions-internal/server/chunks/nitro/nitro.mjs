...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "2aab6992-1664-4a4b-bf1a-e6f03a370bc8",
...
const _NOATpC = lazyEventHandler(() => {
...
const _lazy_IrpLnw = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_IrpLnw, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _NOATpC, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_IrpLnw, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, isScriptProtocol as A, encodeParam as B, withTrailingSlash as C, withoutTrailingSlash as D, handler as E, destr as a, buildAssetsURL as b, createError$1 as c, defineRenderHandler as d, encodePath as e, getRouteRules as f, getQuery as g, getResponseStatusText as h, getResponseStatus as i, joinURL as j, useNitroApp as k, defu as l, hasProtocol as m, parseURL as n, baseURL as o, publicAssetsURL as p, isEqual as q, relative as r, stringifyParsedURL as s, stringifyQuery as t, useRuntimeConfig as u, parseQuery as v, withLeadingSlash as w, withQuery as x, sanitizeStatusCode as y, decodePath as z };
